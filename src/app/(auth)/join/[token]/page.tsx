    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-12" style={{ backgroundColor: '#1C1C1E' }}>
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: '#ffffff' }}>
          ...
          <ul className="space-y-3">
            {FEATURES.map(f => (
              <li key={f} className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 shrink-0 mt-0.5" style={{ color: 'rgba(255,255,255,0.9)' }} />
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-8 py-12 overflow-y-auto">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-2.5 mb-8 lg:hidden">
            ...
            <span className="font-semibold text-foreground text-sm">PixelFlow</span>
          </div>
