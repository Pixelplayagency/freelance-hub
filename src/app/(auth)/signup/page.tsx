    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-12" style={{ backgroundColor: '#1C1C1E' }}>
        ...
        <div>
          <h2 className="text-3xl font-bold text-white leading-snug mb-3">
            Start managing projects<br />the modern way
          </h2>
          <p className="text-slate-400 text-sm mb-8 leading-relaxed">
            Join freelance teams who use FreelanceHub to stay on top of their work.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 mb-8">Join FreelanceHub today</p>

          <SignupForm />

          <p className="text-center text-sm text-slate-500 mt-6">
            Already have an account?{' '}
            <Link href="/login" className="font-semibold hover:opacity-80 transition-opacity" style={{ color: '#f24a49' }}>
              Sign in
            </Link>
          </p>
        </div>
