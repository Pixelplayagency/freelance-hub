...
function getDisplayStatus(entry: ContentPlan): { label: string; color: string; bg: string } {
  ...
  if (entry.status === 'posted')
    return { label: 'PUBLISHED', color: 'var(--primary)', bg: '#fff1f1' }
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mb-1.5">
                            <div className="flex items-center gap-1">
                              ...
                              {ds === todayDS && inMonth && (
                                <span className="text-[8px] font-extrabold text-primary uppercase tracking-wide leading-none">Today</span>
                              )}
                            </div>
                            {inMonth && (
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-5">
            ...
            <div>
              ...
              <input type="time" value={panel.scheduled_time}
                ...
                className="w-full text-xs border border-border rounded-lg px-3 py-2 bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary" />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs border border-border rounded-lg px-3 py-2 bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary resize-none leading-relaxed"
              />
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-1.5">
                ...
                <button
                  ...
                  className="aspect-square rounded-lg border border-dashed border-border flex flex-col items-center justify-center gap-1 text-muted-foreground hover:text-foreground hover:border-primary transition-colors disabled:opacity-50"
                >
                  {panel.uploading
