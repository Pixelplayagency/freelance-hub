      ...
      <div className="bg-white rounded-lg border border-[#EBEBEB] overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
        ...
        <div className="p-4">
          <div className="flex items-start gap-2 mb-1">
            <h3 className="font-semibold text-slate-900 flex-1 leading-snug">{project.name}</h3>
            {project.status === 'archived' && (
              <span className="text-[10px] font-semibold uppercase tracking-wide text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded shrink-0">
                Archived
              </span>
            )}
          </div>
